...
public class MarkerFetcher {
    ...
    public void loadMarkersFromLocalStorage(GoogleMap map) {
    ...
    public void addNewMarker(CustomMarker customMarker, GoogleMap map) {
    ...
    public LatLngBounds addMarkers(final Context context, GoogleMap map) {
